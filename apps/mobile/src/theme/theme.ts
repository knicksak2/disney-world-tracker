...
> = {
  ...
  Walkthrough: { glyph: 'footsteps', tint: '#00897b', label: 'Walkthrough' },
  PlayArea: { glyph: 'football', tint: '#43a047', label: 'Play Area' },
  Game: { glyph: 'game-controller', tint: '#8e24aa', label: 'Game' },
